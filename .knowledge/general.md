...
## 5. DOCUMENTATION GOVERNANCE (MANDATORY)
Feature Documentation: For EVERY feature (new or existing), you MUST:

1. **Validate** if documentation exists for the functionality.

2. **Create** comprehensive documentation if none exists.

3. **Update** existing documentation with the latest information if it already exists.

Documentation Requirements:

- Location: Store feature documentation in `.knowledge/features/` directory.

- Format: Use markdown with clear sections: Purpose, Usage, API/Interface, Examples, Edge Cases.

- Completeness: Document all public APIs, configuration options, and integration points.

- Timeliness: Documentation updates are NOT optional—they are part of feature completion.

Enforcement: Any feature implementation without proper documentation is considered INCOMPLETE.

## 6. DESIGN PHILOSOPHY (HARDCODED)
...
## 8. MCP & EXTERNAL DATA GOVERNANCE
