...
def step_impl_click_element(context, element_name):
    ...
    folder_step_path =get_image_path_from_feature_and_tag(dirpath, scenario_tags, element_name)
...
def step_impl_type_in_field(context, text_to_type, field_name):
    ...
    dirpath = context.feature.filename
    scenario_tags = context.scenario.tags
    folder_step_path = get_image_path_from_feature_and_tag(dirpath, scenario_tags, field_name)
    try:
...
def step_impl_see_text(context, text_to_find):
    ...
    dirpath = context.feature.filename
    scenario_tags = context.scenario.tags
    folder_step_path =get_image_path_from_feature_and_tag(dirpath, scenario_tags, text_to_find)
...
def step_impl_see_option_in_screen(context, option_name):
    ...
    dirpath = context.feature.filename
    scenario_tags = context.scenario.tags
    folder_step_path =get_image_path_from_feature_and_tag(dirpath, scenario_tags, option_name)
